...
// Note: Check if the primitive style is actually needed now the insets are part of ListRow.
...
// Note: Fix the previews, either the style should expand the label to fill or
